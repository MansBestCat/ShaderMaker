...
export class GradientTextureMaterial extends ShaderMaterial {
    uniforms = {
        uStartY: { value: -2.5 },  /*  TODO: Validate start l.t. end. uv.y value, range from 0 to 1 */
        uEndY: { value: 1.0 },   /* uv.y value, range from 0 to 1 */
        uStartColor: { value: new Vector3(1.0, 0.0, 0.0) },
        uEndColor: { value: new Vector3(0.0, 0.0, 0.0) },
